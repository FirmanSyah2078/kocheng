<x-layout>
    <div class="p-10">
        ...
        <a href="{{ route('dashboard.admin.index', ['tab' => 'transactions']) }}"
        ...
        <div class="grid grid-cols-2 gap-4 my-6 bg-white p-6 rounded-2xl shadow-sm">
            <div>
                <p class="text-xs text-secondary">Pelanggan</p>
                <p class="font-semibold">{{ $data->user->name }}</p>
            </div>
            <div>
                <p class="text-xs text-secondary">Metode Pembayaran</p>
                <p class="font-semibold uppercase">{{ $data->payment_method }}</p>
            </div>
            <div>
            ...
            <div>
                <p class="text-xs text-secondary">Tanggal</p>
                <p class="font-semibold">{{ $data->created_at->format('d M Y, H:i') }}</p>
            </div>
        </div>
        ...
        <div class="mt-6 text-right">
            <p class="text-secondary">Total: <span
                    class="text-primary font-bold">{{ $data->formatted_total_amount }}</span></p>
        </div>
    </div>
</x-layout>
