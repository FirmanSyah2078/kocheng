...
<section
    ...
    <img class="w-full h-40 mb-4 object-cover transition-all duration-300" src="{{ $images }}" alt=""
        srcset="">
    ...
    <div class="flex items-center justify-between w-full mt-auto">
        ...
        <form action="{{ route('cart.add', $id) }}" method="POST">
            @csrf
            <button type="submit"
                class="bg-primary cursor-pointer relative overflow-hidden py-2 px-3 rounded-tl-2xl rounded-br-2xl group-hover:scale-110 transition-all duration-300 w-12 h-10 flex items-center justify-center">
